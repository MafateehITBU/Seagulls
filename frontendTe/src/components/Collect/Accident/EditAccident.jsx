...
export default function EditAccident({ sortedData, technicianInfo, editIdTicket, fetchData }) {
    ...
    const insertCroca = async (ID) => {
        try {
            ...
            await axios.put(`${request.defaults.baseURL}technician/booking/edit-accident/${ID}`, formData, {
                headers: {
            ...
            <div className="modal-dialog modal-lg">
                <div className="modal-content">
                    <div className="modal-header">
                        <h1 className="modal-title fs-5" id="EditAccidentLabel">Edit Accident</h1>
