...
const AccidentFiltersSchema = new Schema({
    TicketID: {
        type: String,
        trim: true,
    },
...
//Model Accident Filters
const AccidentFilters = mongoose.model("AccidentFilters", AccidentFiltersSchema)


module.exports = { AccidentFilters }
...
// AccidentFilters.insertMany(data)
//     .then((docs) => {
//         console.log('done');
//     })
//     .catch((error) => {
