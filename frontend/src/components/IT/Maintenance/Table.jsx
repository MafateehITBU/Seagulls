...
import ApprovedMaintenance from './ApprovedMaintenance';
...
export function TableSortMaintenance() {
    ...
    const showTable = filteredRows.length > 0 ? (
        filteredRows.map((row) => (
            <tr key={row._id}>
                ...
                <td>
                    <>
                        <button type="button" onClick={() => setEditId(row._id)} className="btn btn-success me-2" data-bs-toggle="modal" data-bs-target="#approvedSparePartsMaintenance">
                            <i className="fa-solid fa-check"></i>
                        </button>

                        <button type="button" className="btn btn-danger" onClick={() => setEditId(row._id)} data-bs-toggle="modal" data-bs-target="#rejectedSparePartsMaintenance">
    ...
    return (
        <>
            <ApprovedMaintenance adminInfo={adminInfo} editId={editId} fetchData={fetchData} />
