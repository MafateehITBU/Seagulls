...
export default function Rejected({ editId, adminInfo, fetchData }) {
    ...
    const handleRejected = async (ID) => {
        try {
            await axios.put(`${request.defaults.baseURL}Approved/Rejected/${ID}`, { rejectedIT: rejectedReason }, {
                headers: {
    ...
    return (
        <div className="modal fade" id="rejectedSpareParts" tabIndex={-1} aria-labelledby="rejectedSparePartsLabel" aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    <div className="modal-header">
                        <h1 className="modal-title fs-5" id="rejectedSparePartsLabel">Rejected Ticket</h1>
