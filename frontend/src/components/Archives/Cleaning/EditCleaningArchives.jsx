...
export default function EditAccidentArchives({ adminInfo, editId, fetchData }) {
    ...
    const handleSubmit = (id) => {
        EditTicketCleaning(id)
    };

    const EditTicketCleaning = async (ID) => {
        // try {
        //     await axios.put(`${request.defaults.baseURL}cleaning-filters/${ID}`, {
        //         priority,
        //         assetName,
        //         assetType,
        //         assetSubType,
    ...
    return (
        <div className="modal fade" id="EditCleaningArchives" tabIndex={-1} aria-labelledby="EditCleaningArchivesLabel" aria-hidden="true">
            <div className="modal-dialog modal-lg">
                <div className="modal-content">
                    <div className="modal-header">
                        <h1 className="modal-title fs-5" id="EditCleaningArchivesLabel">Edit Cleaning Filters</h1>
