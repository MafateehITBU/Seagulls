...
export default function EditAccidentArchives({ adminInfo, editId, fetchData }) {
    ...
    const handleSubmit = (id) => {
        EditTicketMaintenance(id)
    };

    const EditTicketMaintenance = async (ID) => {
        try {
            await axios.put(`${request.defaults.baseURL}maintenance-filters/${ID}`, {
                priority,
                assetName,
                assetType,
                assetSubType,
    ...
    return (
        <div className="modal fade" id="EditMaintenanceArchives" tabIndex={-1} aria-labelledby="EditMaintenanceArchivesLabel" aria-hidden="true">
            <div className="modal-dialog modal-lg">
                <div className="modal-content">
                    <div className="modal-header">
                        <h1 className="modal-title fs-5" id="EditMaintenanceArchivesLabel">Edit Accident Filters</h1>
