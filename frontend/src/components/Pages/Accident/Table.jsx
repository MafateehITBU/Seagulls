...
export function TableSort() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`${request.defaults.baseURL}Accident`);
        ...
        filteredRows.map((row) => (
            <tr key={row._id}>
                ...
                {/* <td>{row.openedTo !== "" ? (
                    ...
                    < SendEmail time={row.time} id={row._id} />
                )}
                </td> */}
                <td>
                    {row.time}
                ...
                <td>
                    {
                        row.status === "pending" ? (
                            ...
                            <button type="button" className="btn btn-danger" onClick={() => setcloseTicketId(row._id)} data-bs-toggle="modal" data-bs-target="#CloseAccidentTicket">
                                Close Ticket
                            </button>
                        ) : (
                            <></>
    ...
    return (
        <>
            ...
            <EditAccident adminInfo={adminInfo} editId={editId} fetchData={fetchData} />
            ...
            <div className='Table-scroll'>
                <Table horizontalSpacing="sm" verticalSpacing="sm" miw={4500} sx={{ tableLayout: 'fixed' }}>
                    <thead>
                        <tr>
                            <Th
