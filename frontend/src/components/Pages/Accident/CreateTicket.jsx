...
export default function CreateTicket({ adminInfo, fetchData }) {
    ...
    const createTicketAcc = async () => {
        try {
            ...
            const response = await axios.post(`${request.defaults.baseURL}Accident`, formData, {
                headers: {
    ...
    return (
        <div className="modal fade" id="createAccident" tabIndex={-1} aria-labelledby="createAccidentLabel" aria-hidden="true">
            <div className="modal-dialog modal-lg">
                <div className="modal-content">
                    <div className="modal-header">
                        <h1 className="modal-title fs-5" id="createAccidentLabel">Create Accident Ticket</h1>
