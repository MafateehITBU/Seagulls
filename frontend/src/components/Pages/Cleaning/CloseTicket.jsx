...
export default function CloseTicket() {
    return (
        <div className="modal fade" id="CloseCleaningTicket" tabIndex={-1} aria-labelledby="CloseCleaningTicketLabel" aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    <div className="modal-header">
                        <h1 className="modal-title fs-5" id="CloseCleaningTicketLabel">Close Ticket</h1>
