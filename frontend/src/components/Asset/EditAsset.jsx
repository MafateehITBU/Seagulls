...
export default function EditAsset({ adminInfo, fetchData, assetId }) {
    ...
    const handleSubmit = (assetId) => {
        ...
        if (Object.keys(newErrors).length > 0) {
            ...
            createAssetTable(assetId);
        }
    }


    const createAssetTable = async (ID) => {
        try {
            ...
            const response = await axios.put(`${request.defaults.baseURL}Asset/${ID}`, formData, {
                headers: {
    ...
    return (
        <div className="modal fade" id="EditAsset" tabIndex={-1} aria-labelledby="EditAssetLabel" aria-hidden="true">
            <div className="modal-dialog modal-lg">
                <div className="modal-content">
                    <div className="modal-header">
                        <h1 className="modal-title fs-5" id="EditAssetLabel">Edit Asset</h1>
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="button"
                            className="btn btn-primary" onClick={() => handleSubmit(assetId)}>Create Asset</button>
                    </div>
                </div>
            </div >
        </div >
