...
export default function Admin() {
    ...
    const CreateAccountAdmin = async () => {
        try {
            const response = await axios.post(`${request.defaults.baseURL}authAd/register`, {
                username,
                email,
                position,
                phone,
                ...
                <div className="col-lg-7">
                    <div className="card shadow-lg border-0 rounded-lg mt-5">
                        <div className="card-header">
                            <h3 className="text-center font-weight-light my-4">Create Account Admin</h3>
                        </div>
                                ...
                                <div className="row mb-3">
                                    <div className="col-md-12">
                                        <div className="form-floating mb-3 mb-md-0">
                                            ...
                                            />
                                            <label htmlFor="inputUsername">Admin Name</label>
                                        </div>
                                ...
                                <div className="row mb-3">
                                    <div className="col-md-12">
                                        <div className="form-floating mb-3 mb-md-0">
                                            ...
                                            <label htmlFor="selectPostion">Postion</label>
                                        </div>
